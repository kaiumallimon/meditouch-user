        ...
        child: StreamBuilder<List<DoctorModel>>(
          ...
          builder: (context, snapshot) {
            ...
            if (_filteredDoctors.isEmpty && _searchController.text.isEmpty) {
              _filteredDoctors = doctors; // Display all if no filter
            }
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () async {
                    ...
                    final rating = await ReviewRepository().calculateRating(doctor.id);
      ...
      if (query.isEmpty) {
        ...
        _filteredDoctors = _allDoctors.where((doctor) {
          ...
          return doctor.name.toLowerCase().contains(queryLower) ||
              doctor.email.toLowerCase().contains(queryLower) ||
              doctor.phone.toLowerCase().contains(queryLower) ||
              doctor.district.toLowerCase().contains(queryLower) ||
